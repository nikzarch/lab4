...
public class Thing extends Essence implements Layable {
    ...
    public boolean equals(Object obj) {
        if (this.hashCode() != obj.hashCode() || !(obj instanceof Thing thing)) {
            return false;
        }
        if (this == obj) {
            return true;
    ...
    public static class Container extends Thing implements Containable {
        ...
        public void add(Thing thing) throws ContainerPutInContainerException {
            if (thing instanceof Thing.Container)
                throw new ContainerPutInContainerException("Нельзя класть контейнер в контейнер");
        ...
        public boolean equals(Object obj) {
            ...
            if (this.hashCode() != obj.hashCode() || !(obj instanceof Container container)) {
                return false;
            }
            if (this == obj) {
                return true;
